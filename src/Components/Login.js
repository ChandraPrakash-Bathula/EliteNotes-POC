...
<>
      ...
      <form
        ...
        className="absolute md:my-36 lg:my-36 my-36 mx-auto p-10 font-serif text-white bg-black rounded-lg md:w-6/12 lg:w-3/12 w-8/12 right-0 left-0 bg-opacity-80"
      >
