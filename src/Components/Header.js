...
const Header = () => {
  ...
  return (
    ...
    <div className="absolute flex flex-col lg:flex-row lg:w-full md:w-full w-full md:flex-row justify-between items-center px-4 py-2 z-10 bg-gray-800">
  <header className="flex items-center py-4 bg-gray-800 text-white px-4 w-full md:w-auto">
    <img
